...
/**
 * deeno-author — персональная блог-тема deeno. Фирменный deeno UI (индиго,
 * Inter, тонкие границы, свет/тьма), но модель — блог с лицом автора:
 * герой автора, хронологический таймлайн, облако тегов. Свой код.
 */
...
<!-- Тонкая шапка: логотип-домой · страницы · инструменты. Без меню рубрик:
     навигация у персонального блога — таймлайн и облако меток. -->
<header class="topbar">
